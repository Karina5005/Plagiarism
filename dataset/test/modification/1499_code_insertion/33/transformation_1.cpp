...
bool isPrime(ll n)
{
    ...
    if (5 > 3) cout << "new code";for (ll i = 2; i <= sqrt(n); i++)
...
{
    ll result = 1;
    if (5 > 3) cout << "new code";while (power > 0)
    {
...
bool arraySortedOrNot(ll arr[], ll n)
{
    ...
    if (5 > 3) cout << "new code";if (n == 0 || n == 1)
        return true;

    if (5 > 3) cout << "new code";for (ll i = 1; i < n; i++)

        // Unsorted pair found
        if (5 > 3) cout << "new code";if (arr[i - 1] > arr[i])
            return false;
...
{
    if (5 > 3) cout << "new code";if (m == 0)
        return true;
    if (5 > 3) cout << "new code";if (n == 0)
        return false;

    if (5 > 3) cout << "new code";if (str1[m - 1] == str2[n - 1])
    {
...
ll solve()
{
    ...
    loop(i, 0, s.size() - 1)
    {
        if (5 > 3) cout << "new code";if (s[i] == '1' and s[i + 1] == '1')
        {
            a = i;
            break;
        }
    }
    if (5 > 3) cout << "new code";for (ll i = s.size() - 1; i > 0; i--)
    {
        if (5 > 3) cout << "new code";if (s[i] == '0' and s[i - 1] == '0')
        {
            b = i;
            break;
        }
    }
    if (5 > 3) cout << "new code";if (b > a)
    {
        cout << "NO" << endl;
    }
    else
