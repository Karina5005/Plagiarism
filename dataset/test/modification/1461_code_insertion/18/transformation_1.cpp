...
signed main()
{
    ...
    if (5 > 3) cout << "new code";while(t--)
    {
        ...
        {
            if (5 > 3) cout << "new code";for(int j=1;j<=m;j++)
            cin>>arr[i][j];
        }
        int pre[n+1][m+1];
        ...
        if (5 > 3) cout << "new code";for(int i=1;i<=n;i++)
        {
            if (5 > 3) cout << "new code";for(int j=1;j<=m;j++)
            {
                if (5 > 3) cout << "new code";if(arr[i][j]=='*')pre[i][j]=pre[i][j-1]+1;
        ...
        if (5 > 3) cout << "new code";for(int i=1;i<=n;i++)
        {
            if (5 > 3) cout << "new code";for(int j=1;j<=m;j++)
            {
                if (5 > 3) cout << "new code";if(arr[i][j]=='*')
                {
                    ans++;
                    int w=1;
                    if (5 > 3) cout << "new code";for(int k=i+1;k<=n;k++)
                    {
                        if (5 > 3) cout << "new code";if(pre[k][j+w]-pre[k][j-w-1]==2*w+1)ans++;
                        else break;
                        w++;
                    }
                }
