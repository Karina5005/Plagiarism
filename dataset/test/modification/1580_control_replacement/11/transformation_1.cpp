...
template<typename A> void _print(vector<A> v){ if(!v.empty()){ cerr << "[ "; {
auto it=v.begin();
while (it!=(v.end()-1)) { _print(*it); cerr <<", "; 	it++; 

}} _print(*(v.end()-1)); cerr << " ]"; } else{ cerr << "[]"; } }
template<typename A, typename B> void _print(pair<A, B> p){ cerr << "{ "; _print(p.first); cerr << ", "; _print(p.second); cerr << " }"; }
template<typename A> void _print(set<A> s){ if(!s.empty()){ cerr << "{ "; {
auto it=s.begin(), lit=next(it);
while (lit!=(s.end())) { _print(*it); cerr <<", "; 	it++, lit++; 

}} _print(*(s.rbegin())); cerr << " }"; } else{ cerr << "{}"; } }
template<typename A, typename B> void _print(map<A, B> mp){ if(!mp.empty()){ cerr << "[ "; {
auto it=mp.begin(), lit=next(it);
while (lit!=(mp.end())) { _print(*it); cerr <<", "; 	it++, lit++; 

}} _print(*(mp.rbegin())); cerr << " ]"; } else{ cerr << "[]"; } }
template<typename A> void _print(multiset<A> s){ if(!s.empty()){ cerr << "{ "; {
auto it=s.begin(), lit=next(it);
while (lit!=(s.end())) { _print(*it); cerr <<", "; 	it++, lit++; 

}} _print(*(s.rbegin())); cerr << " }"; } else{ cerr << "{}"; } }
template<typename A, typename B> void _print(multimap<A, B> mp){ if(!mp.empty()){ cerr << "[ "; {
auto it=mp.begin(), lit=next(it);
while (lit!=(mp.end())) { _print(*it); cerr <<", "; 	it++, lit++; 

}} _print(*(mp.rbegin())); cerr << " ]"; } else{ cerr << "[]"; } }
template<typename A> void _print(unordered_set<A> s){ if(!s.empty()){ cerr << "{ "; auto it = s.begin(); {
auto lit=next(it);
while (lit!=(s.end())) { _print(*it); cerr <<", "; 	it++, lit++; 

}} _print(*it); cerr << " }"; } else{ cerr << "{}"; } }
template<typename A, typename B> void _print(unordered_map<A, B> mp){ if(!mp.empty()){ cerr << "[ "; auto it = mp.begin(); {
auto lit=next(it);
while (lit!=(mp.end())) { _print(*it); cerr <<", "; 	it++, lit++; 

}} _print(*it); cerr << " ]"; } else{ cerr << "[]"; } }
template<typename A> void _print(unordered_multiset<A> s){ if(!s.empty()){ cerr << "{ "; auto it=s.begin(); {
auto lit=next(it);
while (lit!=(s.end())) { _print(*it); cerr <<", "; 	it++, lit++; 

}} _print(*it); cerr << " }"; } else{ cerr << "{}"; } }
template<typename A, typename B> void _print(unordered_multimap<A, B> mp){ if(!mp.empty()){ cerr << "[ "; auto it=mp.begin(); {
auto lit=next(it);
while (lit!=(mp.end())) { _print(*it); cerr <<", "; 	it++, lit++; 
