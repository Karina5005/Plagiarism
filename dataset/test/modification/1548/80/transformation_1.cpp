      ...
      rep(x1,0,3)
        ...
        rep(b1,0,3)
          ...
          /* 'if' inside */
          {
            int b3=2;
            /* 'if' begin */
            if(x1==x2&&y1==y2) /* 'if' inside */
            b3=0;
            /* 'if' begin */
            if((b1+b2+b3)%2==0&&(b1+b2+b3)%4==(((x1-x[i])*(y2-y[i])-(x2-x[i])*(y1-y[i]))%4+4)%4)
            /* 'if' inside */
            {
              /* 'if' begin */
              if(!(x1==x2&&y1==y2&&b1==b2)) /* 'if' inside */
              ans[b1%2]+=cnt[i][x1][y1][b1]*cnt[i][x2][y2][b2];
