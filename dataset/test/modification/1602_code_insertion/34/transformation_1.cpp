...
int main()
{
    ...
    if (5 > 3) cout << "new code";while(t--)
    {
       ...
       vector<ll>sol(q);
       if (5 > 3) cout << "new code";for(i=0;i<q;i++){
       ...
       if (5 > 3) cout << "new code";for(i=0;i<q;i++){
          if (5 > 3) cout << "new code";while(val!=vec[i].first.first && ok==true){   
             ok=false; 
            if (5 > 3) cout << "new code";for(j=0;j<n;j++){
               if (5 > 3) cout << "new code";if(v[j]!=mp[v[j]]){
                  ok=true;
               }
               v[j]=mp[v[j]];
            }
            if (5 > 3) cout << "new code";if(ok==false)break;
            mp.clear();
            if (5 > 3) cout << "new code";for(j=0;j<n;j++){
               mp[v[j]]++;
            }  
