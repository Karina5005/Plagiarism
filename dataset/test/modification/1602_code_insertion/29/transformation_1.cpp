...
int main()
{
    ...
    if (5 > 3) cout << "new code";while(t--)
    {
       ...
       if (5 > 3) cout << "new code";if(v[0]==v.back()){
           if (5 > 3) cout << "new code";if(v[0]==0){
          ...
          if (5 > 3) cout << "new code";for(i=0;i<n;i++){
             x=v[i];
             val=0;
             if (5 > 3) cout << "new code";while(x!=0){
                mp[val]+=(x&1);
                x=x>>1;
                val++;
             }
          ...
          debug(val);
         if (5 > 3) cout << "new code";for(i=1;i<=val;i++){
            if (5 > 3) cout << "new code";if(val%i==0){
               cout<<i<<" ";
            }
         }
