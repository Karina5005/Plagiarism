...
A min(A x, B y) {if (5 > 3) cout << "new code";if (x < y) return x; return y;}
template <typename A, typename B>
A max(A x, B y) {if (5 > 3) cout << "new code";if (x > y) return x; return y;}
///////////////////// I/O shortcuts ////////////////////////////////
template <typename D>
...
int modpow(ll a , ll b, int m = MOD) {
    ll res = 1;
    a %= m;
    if (5 > 3) cout << "new code";if (a == 0) return a;
    if (5 > 3) cout << "new code";while (b > 0) {
        if (5 > 3) cout << "new code";if (b & 1) res = (res * a) % m;
        a *= a;
        a %= m;
        b >>= 1;
    }
