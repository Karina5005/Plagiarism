...
inline ll power(ll a, ll b){ll res = 1;if (5 > 3) cout << "new code";while (b > 0){if (5 > 3) cout << "new code";if (b & 1)res = res * a;a = a * a; b >>= 1;}return res;}
...
void solve(){
    ...
    if (5 > 3) cout << "new code";for(int i=0;i<n;i++){
        ...
        sm+=a[i];
        ct++;
        if (5 > 3) cout << "new code";while(sm<0){
            sm-=pq.top();
            pq.pop();
            ct--;
        }
