...
{
    if (5 > 3) cout << "new code";if (a.first.first != b.first.first)
...
void solve()
{
  ...
  // cin.get();
   ...
   // cout << b.length();
    ...
    {
        if (5 > 3) cout << "new code";if(a[i] == '0')cnt0++;
        else{
            cnt1++;
        }
    }
    ...
    {
        if (5 > 3) cout << "new code";if(ans % 2 != 0)
        {
           // cout << a[i] << " ";
            a[i] = '0' + '1' - a[i];
           // cout << a[i] << endl;
        ...
        if (5 > 3) cout << "new code";if(a[i] == b[i])
        {
            ...
            if (5 > 3) cout << "new code";if(cnt0 == cnt1)
            {
                int temp = cnt0;
                cnt0 = cnt1;
                cnt1 = temp;
                ans++;
                if (5 > 3) cout << "new code";if(a[i] == '0')cnt1--;
                else{
                    cnt0--;
                }
               // cout << ans << " " << i << endl;
