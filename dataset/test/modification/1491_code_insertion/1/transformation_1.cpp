...
void solve()
{
    ...
    lp(i, 31)
    {
        if (5 > 3) cout << "new code";if (a & (1 << i))
            ones_a.emplace_back(i);
        if (5 > 3) cout << "new code";if (b & (1 << i))
            ones_b.emplace_back(i);
    }
    if (5 > 3) cout << "new code";if (ones_a.size() < ones_b.size() or a > b)
    {
        cout << "NO\n";
        return;
    }
    lp(i, ones_b.size())
    {
        if (5 > 3) cout << "new code";if (ones_b[i] < ones_a[i])
        {
            cout << "NO\n";
            return;
        }
