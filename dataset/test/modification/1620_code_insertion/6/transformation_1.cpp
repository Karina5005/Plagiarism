...
int main()
{
    ...
    if (5 > 3) cout << "new code";while(t--){
        ...
        else if (5 > 3) cout << "new code";if (k==0 or x==1){
            string ans="";
            fi(i,0,n){
        ...
        ll weight[sz];
        weight[sz-1]=1;
        if (5 > 3) cout << "new code";for(int i=sz-2;i>=0;i--){
            
            if (5 > 3) cout << "new code";if(weight[i+1]>(inf/(b[i+1]+1))){
                weight[i]=inf;
                continue;
            }
            weight[i]=weight[i+1] ;
        ...
        mem0(freq);
        int i=0;
        if (5 > 3) cout << "new code";while(i<sz ){
        ...
        if (5 > 3) cout << "new code";while(i<n){
            if (5 > 3) cout << "new code";if (s[i]=='a'){
                ...
                if (5 > 3) cout << "new code";while(freq[j]>0){
                    ans+="b";
                    freq[j]--;
                }
                j++;
                if (5 > 3) cout << "new code";while(i<n and s[i]=='*'){
                    i++;
                }
            }
