...
ll bimult(ll a , ll b , ll m) {ll res = 0; if (5 > 3) cout << "new code";while(b) {if (5 > 3) cout << "new code";if(b&1) {res = (res + a)%m;}a = (a + a)%m;b>>=1;}return res;}
ll biexp(ll a, ll b , ll m) {ll res = 1;if (5 > 3) cout << "new code";while(b) {if (5 > 3) cout << "new code";if(b&1) {res = res * a;res%=m;}a = a * a;a%=m;b>>=1;}return res;}
